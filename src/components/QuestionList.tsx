    ...
    <div id="questions">
      {questions.map((q) => (
        <div key={q.id} className="question-item">
          ...
          <div className={`answer-content answer-${q.id} ${activeId === q.id && activeTab === 'answer' ? 'open' : ''}`}>
            <div className="block-label">Resposta</div>
            <p>{q.resposta}</p>
          </div>
          <div className={`dicas-content dicas-${q.id} ${activeId === q.id && activeTab === 'dicas' ? 'open' : ''}`}>
            <div className="block-label">Dicas</div>
            <p>{q.dicas}</p>
          </div>
          <div className={`referencia-content referencia-${q.id} ${activeId === q.id && activeTab === 'referencia' ? 'open' : ''}`}>
